...
import dev.sirulex.syncthing.SyncthingApp
...
import dev.sirulex.syncthing.api.dto.PendingFolder
import dev.sirulex.syncthing.native.RunState
import dev.sirulex.syncthing.service.SyncthingService
import dev.sirulex.syncthing.api.dto.Device as DeviceDto
import android.content.ClipData
import android.content.ClipboardManager
import android.content.Context
import dev.sirulex.syncthing.ui.devices.AddDeviceScreen
import dev.sirulex.syncthing.ui.devices.DeviceDetailScreen
import dev.sirulex.syncthing.ui.devices.EditDeviceScreen
import dev.sirulex.syncthing.ui.folders.AcceptFolderDialog
import dev.sirulex.syncthing.ui.folders.AddFolderScreen
import dev.sirulex.syncthing.ui.folders.FolderBrowserScreen
import dev.sirulex.syncthing.ui.folders.FolderDetailScreen
import dev.sirulex.syncthing.ui.folders.IgnoreEditorScreen
import dev.sirulex.syncthing.ui.folders.EditFolderScreen
import dev.sirulex.syncthing.ui.folders.PendingFolderUi
import dev.sirulex.syncthing.ui.folders.appendIgnorePattern
import dev.sirulex.syncthing.api.dto.BrowseEntry
import dev.sirulex.syncthing.data.ConflictResolver
import dev.sirulex.syncthing.data.FolderCondition
import dev.sirulex.syncthing.data.SettingsBackupCodec
import dev.sirulex.syncthing.data.parseFolderConditions
import dev.sirulex.syncthing.ui.errors.ConflictScreen
import dev.sirulex.syncthing.ui.errors.ErrorCenterScreen
import dev.sirulex.syncthing.ui.home.HomeScreen
import dev.sirulex.syncthing.ui.home.InsightsScreen
import dev.sirulex.syncthing.ui.home.RecentChangesScreen
import dev.sirulex.syncthing.ui.core.theme.SyncthingMotion
import dev.sirulex.syncthing.ui.share.ShareTargetScreen
import dev.sirulex.syncthing.ui.share.copyUrisToFolder
...
import dev.sirulex.syncthing.ui.onboarding.OnboardingScreen
import dev.sirulex.syncthing.ui.qr.ShowQrDialog
import dev.sirulex.syncthing.ui.qr.QrScannerScreen
import dev.sirulex.syncthing.ui.settings.BatteryWizardScreen
import dev.sirulex.syncthing.ui.settings.BiometricLockScreen
import dev.sirulex.syncthing.ui.settings.ConnectivitySettingsScreen
import dev.sirulex.syncthing.ui.settings.DiagnosticsScreen
import dev.sirulex.syncthing.ui.settings.ProfilesScreen
...
fun AppNavigation(
    ...
    NavHost(
        ...
        composable<ConnectivitySettingsRoute> {
            var options by remember { mutableStateOf<dev.sirulex.syncthing.api.dto.ConnectivityOptions?>(null) }
            LaunchedEffect(serviceState) {
