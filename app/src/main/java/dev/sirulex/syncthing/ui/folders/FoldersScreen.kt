...
import dev.sirulex.syncthing.ui.core.components.StatusChip
import dev.sirulex.syncthing.ui.core.format.formatBytes
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            if (hasProgress) {
                ...
                Text(
                    text = "${(progress * 100).toInt()}% — ${dev.sirulex.syncthing.ui.core.format.formatBytes(inSyncBytes)} / ${dev.sirulex.syncthing.ui.core.format.formatBytes(globalBytes)}",
